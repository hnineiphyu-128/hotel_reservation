            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="{{asset('loginregister/images/signin-image.jpg')}}" alt="sing up image"></figure>
                    ...
                    <div class="signin-form">
                        ...
                        <form action="{{ route('login') }}" method="POST" class="register-form" id="login-form">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="email" class="@error('email') is-invalid @enderror" name="email" id="your_name" value="{{ old('email') }}" required autocomplete="email" placeholder="Your Email..." autofocus />
